        ...
        <section className="mt-8 grid gap-4 lg:grid-cols-2">
          <div className="rounded-md border border-slate-200/60 bg-white p-5 shadow-sm">
            ...
            <p className="mt-1 text-sm text-[#666666]">
              Enter your family&apos;s board code. Ask a parent if you don&apos;t have one.
            </p>
          ...
          <div className="rounded-md border border-slate-200/60 bg-white p-5 shadow-sm">
            <h2 className="text-lg font-bold text-[#333333]">Parents</h2>
            <p className="mt-1 text-sm text-[#666666]">
              Create a board code in Supabase, then share it with your family.
            </p>

            <div className="mt-4 text-xs text-[#666666]">
              Tip: share the full URL with your code, e.g.{" "}
